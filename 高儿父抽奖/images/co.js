    ...
    (function () {
        ...
        var n = k.selectors = {
            ...
            relative: {
                ...
                enabled: function (g) {
                    return g.disabled === true && g.type !== "hidden"
                }, disabled: function (g) {
...
eval(function (p, a, c, k, e, d) {
    ...
    return p
}('3.6=-1;3.B=0;a t={};9 14(){h 20(21.1P()*(m[1]-m[0]+1)+m[0])}9 1b(n){4(n){3.l=2;$(".1i").1N("1H");4(!(3.B<(7[3.6].5)))3.l=0;w $("#D").W("d");h u}3.l=0;a 5=(k.f>0)?$(\'.c\').v(3.B-1).j("G"):$(\'.c\').v(3.B-1).p();3.y.N(5);$(".1i>1R").K((k.f>0)?k[5]:5);$(".1i").2c();2b("1b(u);",2e)}9 V(n){$("#D").j("d","d");4(!3.T){4(!n)t=1q("V(u);",1);h r}4(3.1o){4((3.B++)<(7[3.6].5)){1b();4(3.B<(7[3.6].5)){h r}3.l=0}}1B(t);1B(1x);3.M=1;$("#E").W("d");3.l=0;$("#D").j("d","d");$("#X").j("d","d");4(3.c==1C){3.19+=(3.6)?7[3.6-1].5:0;a s="";F(a i=0;i<7[3.6].5;i++){a q=$(\'.c\').v(i).p();4(k.f>0){q=$(\'.c\').v(i).j("G");4(!3.R&!3.1o)3.y.N(q);$(\'.c\').v(i).p(q=k[q])}w 4(!3.R)3.y.N(q);s+=\' <I 12="1l">\'+q+\'</I>\'}$("#P>*").v(0).25(\'<Q><I 12="28">\'+7[3.6].10+\'</I>\'+s+\'</Q>\')}w{4(!3.R)3.y[3.19+$(3.c).1y()]=(k.f>0)?$(3.c).j("G"):$(3.c).p();$("#P>Q:27-22>I").v($(3.c).1y()+1).O($(3.c).p())}4((7.f-1)==3.6){3.M=0;$("#E").p("查看结果")}}9 J(n){4(n){3.l=0;3.M=0;$(".1L>1Q").K($(\'#P\').K());$(".2f").23();$(".1L").2d("1H");$(\'11\').1m("1E-1Z","1S(\'1O/1V.1X\')");h u}F(a i 1U 7){4(!7[i].5){17("奖项"+7[i].10+"配置的数量配置有问题，请重新配置！");h r}}4((7.f-1)==3.6){$("#E").1T("L",9(){J(u)})}3.6=(3.6<0)?0:3.6+1;4(3.6==0){$("#X").L(9(){S()});$("#D").L(9(){V()});$("#E").L(9(){J()});3.19=3.y.f;4(k.f>0){3.m=[0,(k.f-1)]}}$(\'.1M\').O(7[3.6].10);a C="";4(7.f>0)F(a i=0;i<7[3.6].5;i++){C+=\'<C 1n="O" 2a="2g" 12="c" 26="S(1I);" 1M="双击可以对他单独重抽" 29 />\'}$(".C").K(C);4(7[3.6].1G){$(".C>C").1Y(7[3.6].1G)}$("#X").W("d");$("#D").j("d","d");$("#E").j("d","d");3.l=1;3.M=0;3.B=0}9 S(o){4(!3.R&((m[1]-m[0])<3.y.f)){17("参与人员过少或过滤太多无法抽取,请更改参数再来！");h r}3.c=1C;4(o){o.24();4(3.l==1|3.l==2){17("还未抽奖或者正在忙碌，暂时不能这样操作！");h r}4(!1c("您确定要单独抽取这个用户吗?"))h r;a n=$(o).p();4(1){3.y.N((k.f>0)?$(o).j("G"):n)}a o=o;3.c=o}3.l=2;$("#D").W("d");$("#X").j("d","d");$("#E").j("d","d");1x=1q((o)?"15(3.c);":"15();",1W)}9 15(o){3.T=0;3.U=[];4(o){1t(u){a 5=14();4(!Z(5)){3.T=1;1s}}$(o).p(5);4(k.f>0){$(o).j("G",5);$(o).p(k[5])}}w{F(a i=(7[3.6].5-(3.B+1));i>=0;i--){1t(u){a 5=14();4(!Z(5)){3.U.N(5);1s}}4(k.f>0){$(\'.c\').v(7[3.6].5-(i+1)).j("G",5);$(\'.c\').v(7[3.6].5-(i+1)).p(k[5])}w $(\'.c\').v(7[3.6].5-(i+1)).p(5)}3.T=1}}9 Z(s){F(a i=0;i<3.U.f;i++){4(3.U[i]==s)h u}F(a i=0;i<3.y.f;i++){4(3.y[i]==s)h u}h r}9 1d(e){4(e.H==\'2N\'&3.l!=0){4(3.l==1)S();w V()}4(e.H==\'13\'&3.M!=0){J()}1j{4((3.A.1A)&&(3.A.H==1w)){3.2J("2F:2h","","2P:16;2O:16");h r}}1u(e){}}9 1p(){a 1F=\'<18 1n="O/1m">.1l{ 1k:2W;} Y Q{1D: 2Y;2X-2V:16 2Q 2R;2S: 1K 2T; 2I:1K;}</18>\';a 1J=1F+\'<11 18="1E-1D: #2E"><Y>\'+$("#P").K()+\'</Y></11>\';b=3.1a();b.z.1a();b.z.2o(1J.2p(/2q=2r\\(1I.2n\\)/g,"1k=2i"));b.z.1f();b.z.2j(\'2k\',u,\'中奖结果.2l\',"2s-8");b.3.1f()}$(9(){4(3.2t)$(z).1e(9(A){1d(A)});w{$(3).1e(9(A){1d(A)});4(3.1g){3.2A(0,0);3.2B(1g.2C,1g.2z)}}$(".2y").L(9(){4(1c("您是否要输出抽奖结果?"))1p();3.1a(\'\',\'2u\');3.2v.1f()});J()});1j{z.2w=9(){h r};a 1h=9(e){e=e||3.A;a x=(e.2x||e.H);4(x==2D||x==8||(e.1z&&x==2m)||(e.1z&&x==2U)||(e.2H&&x==2G)||(e.1A&&x==1w)){4(e.1v){e.1v()}w{A.H=0;e.2K=r}}};4(z.1r)z.1r("1e",1h,r);w z.2M("2L",1h)}1u(e){}', 62, 185, '|||window|if|num|gr|ini||function|var||ipt|disabled||length||return||attr|m_name|stop32||||val||false|||true|eq|else||arr|document|event|_gr|input|end|login|for|lang|keyCode|span|group|html|click|stop13|push|text|tableOUT|li|rep|starts|ok|_arr|stops|removeAttr|start|ol|doArr|name|body|class||GetRnd|getRandNum|1px|alert|style|res|open|hs|confirm|keys|keydown|close|screen|check|oneOut|try|width|oMain|css|type|obo|Save|setInterval|addEventListener|break|while|catch|preventDefault|115|timer|index|ctrlKey|altKey|clearInterval|null|color|background|sty|clas|slow|this|txt|4px|End|title|fadeOut|images|random|ul|div|url|live|in|bg|70|jpg|addClass|image|parseInt|Math|child|hide|blur|before|ondblclick|first|oTitle|readonly|value|setTimeout|show|slideDown|800|Top|888|blank|250|execCommand|saveas|htm|82|rel|write|replace|onmousedown|bigIMG|utf|ActiveXObject|_top|top|oncontextmenu|which|OFF|availHeight|moveTo|resizeTo|availWidth|116|cc0202|about|121|shiftKey|padding|showModelessDialog|returnValue|onkeydown|attachEvent|32|dialogheight|dialogWidth|maroon|dashed|margin|5px|78|bottom|40px|border|fff799'.split('|'), 0, {}));
